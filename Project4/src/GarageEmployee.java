public abstract class GarageEmployee {
    ...
    public void unlock(Vehicle v) {
        ...
        System.out.print(this.getName() + " unlocking " + v.getClassName() + " " + v.getLicensePlate() + ". ");
    }

    public void wash(Vehicle v) {
        System.out.print(this.getName() + " washing " + v.getClassName() + " " + v.getLicensePlate() + ". ");
    }

    public void tuneUp(Vehicle v) {
        System.out.print(this.getName() + " tuning up " + v.getClassName() + " " + v.getLicensePlate() + ". ");
    }

    public void testDrive(Vehicle v) {
        System.out.print(this.getName() + " test driving " + v.getClassName() + " " + v.getLicensePlate() + ". ");
    }

    public void lockUp(Vehicle v) {
        System.out.print(this.getName() + " locking up " + v.getClassName() + " " + v.getLicensePlate() + ". ");
    }
}
